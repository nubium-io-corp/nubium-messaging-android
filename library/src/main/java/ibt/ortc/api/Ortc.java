 ...
 * 			&quot;http://ortc-developers.nubium.io/server/2.1/&quot;, true,
 ...
 *  <pre>
 * OrtcClient client = (new Ortc()).loadOrtcFactory("IbtNubiumSJ").createClient();
 *  client.setApplicationContext(getApplicationContext());
 *  client.setGoogleProjectId("0123456789");
 *  client.setClusterUrl("http://ortc-developers.nubium.io/server/2.1/");
...
public class Ortc {
	 ...
	 * permissions.put(&quot;channel1&quot;, ChannelPermissions.Write);
	 * 
	 * if (!Ortc.saveAuthentication(&quot;http://ortc-developers.nubium.io/server/2.1/&quot;,
	 ...
	 * 
	 * <pre>
	 * Ortc.presence(&quot;http://ortc-developers.nubium.io/server/2.1/&quot;, true,
	 ...
	 * 
	 * <pre>
	 * Ortc.enablePresence(&quot;http://ortc-developers.nubium.io/server/2.1/&quot;, true,
	 ...
	 * 
	 * <pre>
	 * Ortc.disablePresence(&quot;http://ortc-developers.nubium.io/server/2.1/&quot;, true,
	...
	/**
	 * Returns the on message event to be executed when a push notification is received and there is a Nubium Client that is not connected
	...
	/**
	 * Sets the on message event to be executed when a push notification is received and there is a Nubium Client that is not connected
	 * @param onPushNotification
	 * 			Executed when a notification is received and there is a Nubium Client that is not connected 
	 */
